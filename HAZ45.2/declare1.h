c    Declarations for Main file
     ...
     4        nMaxMag2(MAX_FLT), ncountS7(MAX_FLT), nn10000
      integer iBoundFlag, INOUTSTA, I0, I1, bFLAG, nvert
     ...
     4     mechS7(MAX_FLT,MAX_S7), version
      real TVZ_DIST, temp_x, temp_y, xPOL(MAX_NVERT), yPOL(MAX_NVERT),
     1     grid_xPOL(MAX_NVERT),grid_yPOL(MAX_NVERT) 
      real damp, DampingFactor

      character*80 fName(MAX_FLT), attenName(4,MAX_PROB), file1, file2,
     1             sigmaName(4,MAX_PROB), filebmode
      character*100 boundfilein
      integer iii
